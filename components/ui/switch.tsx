...
/* eslint-disable @typescript-eslint/no-unused-vars -- vendored; upstream strips motion-conflicting handlers by destructuring them away */
        ...
        <SwitchPrimitive.Root
          ...
          style={{
            ...
            backgroundColor: checked
              ...
              : hovered
                ? "color-mix(in oklab, var(--switch-track, var(--accent)), rgb(var(--overlay, 0 0 0)) 10%)"
                : "var(--switch-track, var(--accent))",
          }}
