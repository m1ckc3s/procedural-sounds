...
- `instruments.ts` - the instrument bank: 43 coherent single-note voices (struck wood, tines, metal, strings, bodies, transients, air, digital, sustained), each with a plausible register, a decay character and its highest sounding partial.
