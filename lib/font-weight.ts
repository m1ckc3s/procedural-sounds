...
//
// Inter-only: consumers must render in Inter (tab bar uses --font-inter);
// Geist has no opsz axis, so on Geist the compensation is inert and bolding
// visibly widens the glyphs.
